...
first.onclick = function() {window.location.href =  '/Basketball/index.html'
 };  
second.onclick = function() {window.location.href = '/volleyBall/index.html'
 };  
third.onclick = function() {window.location.href = '/TT/index.html'
 };  
fourth.onclick = function() {window.location.href =  '/Badmintion/index.html'
 };  
five.onclick = function() {window.location.href = '/carrom/index.html'
 };  
